...
Here, I am plotting a graphic visualization of some of the genes found in the previous summary that exhibit extremely relevant adjusted p-values and high log-fild change.

```{r}
VlnPlot(data.filt, features = c("2310079G19Rik", "Hist1h3b", "E130012A19Rik", "Matk", "Spink3"), pt.size = 0)
# RidgePlot(data.filt,features = c("2310079G19Rik", "Hist1h3b", "E130012A19Rik", "Matk", "Spink3"))
FeaturePlot(data.filt, features = c("2310079G19Rik", "Hist1h3b", "E130012A19Rik", "Matk", "Spink3"))
DotPlot(data.filt, features = c("2310079G19Rik", "Hist1h3b", "E130012A19Rik", "Matk", "Spink3"))
